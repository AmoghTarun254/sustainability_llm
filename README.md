...
This is a demo of the frontend of the application hosted at port 3000, complete with chatbot capabilities. The chatbot can answer specific questions related to the files provided in the `data` folder (which can be modified as per requirement) or questions pertaining to sustainability in general.
